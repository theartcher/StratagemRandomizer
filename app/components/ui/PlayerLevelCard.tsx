import { Collapse, Grid, Slider, Typography } from "antd";
...
export default function PlayerLevelCard({
  ...
  return (
    <Collapse
      defaultActiveKey={defaultCollapsed ? [] : ["player-level"]}
          ...
          children: (
            <>
              ...
              {!atMax && (
                ...
                >
                  Stratagems with an unlock level above {level} are excluded
                  from the pool.
                </Text>
              )}
            </>
